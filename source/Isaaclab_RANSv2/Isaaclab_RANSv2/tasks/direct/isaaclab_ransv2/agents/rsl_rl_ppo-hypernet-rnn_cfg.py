...
class PPORunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    max_iterations = 2000
    save_interval = 1000
    experiment_name = "AutoEnvGen_RNN_Hypernet"
    logger = "wandb"
    wandb_project = "AutoEnvGen_RNN_Hypernet"
    wandb_kwargs = {
        "project": "AutoEnvGen_RNN_Hypernet",
        "entity": "spacer-rl",
        "group": "zeroG",
    }
    ...
    actor = RslRlRNNHypernetModelCfg(
        hidden_dims=[64, 64],
        activation="tanh",
    ...
    critic = RslRlRNNHypernetModelCfg(
        hidden_dims=[64, 64],
        activation="tanh",
        obs_normalization=False,
        network_type="hybrid",
