...
from ..tasks_cfg import GoThroughPositions3DCfg
...
class GoThroughPositions3DTask(TaskCore):
    ...
    def get_observations(self) -> torch.Tensor:
        ...
        self._local_pos_error = math_utils.quat_apply_inverse(current_quat_w, self._position_error)
        ...
        for i in range(self._task_cfg.num_subsequent_goals - 1):
            ...
            local_subsequent_error = math_utils.quat_apply_inverse(current_quat_w, subsequent_error)
